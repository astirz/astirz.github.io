...
import { _ as __nuxt_component_2, a as __nuxt_component_3 } from "./tag-BXt0q8Nz.js";
import { defineComponent, useSSRContext, withAsyncContext, mergeProps, unref, withCtx, createTextVNode, toDisplayString, ref, computed, createVNode } from "vue";
import { ssrRenderAttrs, ssrInterpolate, ssrRenderComponent, ssrRenderList, ssrRenderAttr } from "vue/server-renderer";
import _sfc_main$4 from "./ContentRenderer-DfocjcYL.js";
import { _ as __nuxt_component_0 } from "./nuxt-link-bJNpUmJ5.js";
import { b as useRoute, d as useRequestEvent, e as useRuntimeConfig, n as navigateTo, u as useHead } from "../server.mjs";
import { q as queryContent, u as useAsyncData } from "./asyncData-BvyDTr1W.js";
import { getRequestURL } from "h3";
import { d as defineOgImageComponent } from "./defineOgImageComponent-BgmoXzya.js";
import "defu";
import "ufo";
import "./_plugin-vue_export-helper-1tPrXgE0.js";
import "./ContentRendererMarkdown-DeA3sTqQ.js";
import "destr";
import "scule";
...
function useSocialShare(options = defaultOptions) {
  ...
  const pageUrl = url !== void 0 ? url : useRequestURL().href;
  const shareUrl = selectedNework.value.shareUrl;
  const argTitle = ((_a = selectedNework.value.args) == null ? void 0 : _a.title) && title ? (_b = selectedNework.value.args) == null ? void 0 : _b.title : "";
  const argUser = ((_c = selectedNework.value.args) == null ? void 0 : _c.user) && user ? (_d = selectedNework.value.args) == null ? void 0 : _d.user : "";
  const argHashtags = ((_e = selectedNework.value.args) == null ? void 0 : _e.hashtags) && hashtags ? (_f = selectedNework.value.args) == null ? void 0 : _f.hashtags : "";
  const argImage = ((_g = selectedNework.value.args) == null ? void 0 : _g.image) && image ? (_h = selectedNework.value.args) == null ? void 0 : _h.image : "";
  let fullUrl = shareUrl + argTitle + argUser + argHashtags + argImage;
  fullUrl = fullUrl.replace(/\[u\]/i, pageUrl).replace(/\[t\]/i, title || "").replace(/\[uid\]/i, user || "").replace(/\[h\]/i, hashtags || "").replace(/\[i\]/i, image || "");
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const isStyled = props.styled !== void 0 ? props.styled : options.styled;
    const isLabeled = props.label !== void 0 ? props.label : options.label;
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<a${ssrRenderAttrs(mergeProps({
        ...
        href: unref(selectedNework).shareUrl,
        style: `--color-brand:${unref(selectedNework).color}`,
        "aria-label": `Share with ${capitalizedNetwork}`,
        target: "_blank"
      }, _attrs))}><svg class="social-share-button__icon" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" role="img" width="1em" height="1em"${ssrRenderAttr("viewBox", `${unref(selectedNework).icon.viewBox}`)}><path fill="currentColor"${ssrRenderAttr("d", `${unref(selectedNework).icon.path}`)}></path></svg>`);
      if (unref(isLabeled)) {
        _push(`<span class="social-share-button__label">Share</span>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</a>`);
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      const _component_BlogHeader = _sfc_main$3;
      const _component_ContentRenderer = _sfc_main$4;
      const _component_BlogToc = _sfc_main$2;
      ...
      _push(`<div class="flex mt-10 flex-row gap-2"><!--[-->`);
      ssrRenderList(["facebook", "twitter", "linkedin", "email"], (network) => {
...
//# sourceMappingURL=_blog_-6lKZEb_r.js.map
